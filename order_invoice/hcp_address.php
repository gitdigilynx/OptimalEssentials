...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $result = $conn->query($sql);
        ...
        if ($result->num_rows > 0) {
          ...
          $sql_insert_address = "INSERT INTO cutomer_address (customer_id, customer_fname, customer_lname,customer_email,customer_phone,customer_zip,customer_address1,customer_address2,customer_city,customer_state,customer_state_code,customer_counrty,compony)
            VALUES ('$customer_id', '$first_name', '$Last_Name','$Email','$Phone_No','$Zip_Code','$Address','$Address2','$City','$State','$customer_state_code','$Country','$Compony')";
