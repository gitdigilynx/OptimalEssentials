...
<div class="card">
  <div class="card-body mx-4">
    <div class="container mt-5">
      <h3 class="text-center mb-5">Invoice Details</h3>
      <div class="row">
          
    
      <div class="mb-4" style="text-align:right;">
          <a href="order_invoice_backend.php"><button type="button" class="btn btn-primary"><i class="fa fa-chevron-circle-left"></i>Back</button></a>
         </div>
    ...
    <div class="col-md-4">
      <ul class="list-unstyled mb-5">
        ...
        <?php 
         ...
         $sql_invoice = "SELECT * FROM customer_invoice where invoice_id=".$invoice_id;
         $result_invoice = $conn->query($sql_invoice);
         if ($result_invoice->num_rows > 0){
             $value_invoice = $result_invoice->fetch_assoc();
             $order_id = $value_invoice['order_id'];
              $invoice_created_date = $value_invoice['invoice_created_date'];
         }
              ...
              $result_order = $conn->query($sql_order);
                ...
                if ($result_order->num_rows > 0){
                    while ($value = $result_order->fetch_assoc()){
                          ...
                          $order_shipped_date	= $value['order_shipped_date'];
          ...
          <li class="mt-3">
           <span>Invoice created on </span><?php echo $invoice_created_date;?>
          </li>
          <?php 
          if($order_shipping_status == 'Shipped')
          {
          ?>
          <li class="mt-3">
           <span>Order shipped on </span><?php echo $order_shipped_date;?>
          </li>
        <?php 
          }
         }
