...
//      print_r($response_draft_order);
    ...
    $draft_order_invoice = '{"draft_order_invoice":{"to":"nasir@digilynx.net","from":"mansoor.pak@gmail.com","subject":"Custom order Invoice","custom_message":"Thank you for ordering!"}}';

    $create_draft_order_invoice = curl_init();
         curl_setopt($create_draft_order_invoice, CURLOPT_URL, "https://optimal-essentials-dev.myshopify.com/admin/api/2022-10/draft_orders/4987563901184/send_invoice.json");
