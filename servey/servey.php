...
<body>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            Apppend_Question_Ans(customerId);
        ...
        var customer_id = '';
         ...
         //   for multiple check end
            ...
            // add class when skip
             ...
             $(document).on('click', '#conform_age', function (e) {
                 alert('asd');
                var age_input_value = $("#get_data_age").val();
                var strinf_for_age = '__'+customerId;
                age_input_value +=strinf_for_age;
                alert(age_input_value);
            ...
            $(document).on('click', '.btn_conform', function (e) {
                ...
                if (i == 3) {
                    ...
                    var strinf_for_age = '___'+customerId;
                    user_age +=strinf_for_age;
                    $('#get_data_age2').val(user_age);
                    if (user_age == '') {
                ...
                if (i == 9) {
                    if ($('#calculate_BMI').hasClass('active')) //check if the confirm button click
                    {
                        ...
                        if (BMI_height === '' || BMI_weight === '') {
                            ...
                            $('#questiontextarea9').prop('disabled', true);  //disbale question19
                            $('#questiontextarea10').prop('disabled', true);  //disable question20
                        }
                        ...
                        $('#questiontextarea9').prop('disabled', false);  //enable question19
                        $('#questiontextarea10').prop('disabled', false);  //enable question20
                    }
                }
               

                if (i == 9) // if i is 19 and skip button is clicked
                {
        ...
        function nextButton() {
            ...
            if ( i == 10 ) // if i is 11 and skip button is clicked
            {
                if ($('#calculate_BMI').hasClass('active')) {
                    i += 2;
                    next_tab = i;
        ...
        function preveButton() {
            ...
            // applying condtion if height weight is not enterd
            if (i == 10) // if i is 19 and skip button is clicked 
            {
                if ($('#calculate_BMI').hasClass('active')) {
                    i -= 2;
                    preve_tab -= 2;
   ...
   function submit_form() {
            ...
            $.ajax({
                method: "POST",
                url: "https://app.optimalessentials.com.au/servey/insert_servey.php?customer_id=" + customerId,
                data: dataString,
                success: function (data) {
                    console.log(data);
                    ...
                    if (data == "sucess") {
                        ...
                        // location.href = '/pages/product-recomendation';
                    }
                }
            });
